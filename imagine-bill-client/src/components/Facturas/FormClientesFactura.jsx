...
export default function FormClientesFactura({ handleForm, handleSubmit, data, searchByDocumento}) {

  return (
    <form className='content-form-clientes-factura' onChange={(e) => handleForm(e)}>

      <div className="heading2-regular grises-1000 div-form-clientes-factura">
